 ...
 * colorA / colorB sourced from endpoint placerColor (immutable per Gemini #1 BLOCKER).
 * Post-Sym D all bonds are same-color (colorA===colorB always). Gradient branches removed.
 */
