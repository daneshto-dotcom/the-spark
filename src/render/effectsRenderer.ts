...
// S10 P4: corner pulse anchor — co-located with HUD progress-bar layout in
// ui.ts (PROGRESS_X=12, PROGRESS_WIDTH=80, PROGRESS_Y vertical track at
