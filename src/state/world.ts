 ...
 * per § XV soft LOC charter (world.ts was at 587 LOC; placePrimitive +
 * makeBond were ~340 of those). Zero behavior change; the dispatch case
 * now delegates to the imported function.
 */
 ...
 * that needs a player by id). Throws if the player is missing — Phase 1
 * solo always has P1, so a miss indicates a misuse.
 */
