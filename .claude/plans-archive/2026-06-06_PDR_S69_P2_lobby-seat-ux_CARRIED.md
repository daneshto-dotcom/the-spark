> STATUS CORRECTED S82 (was: "CARRIED/DEFERRED -- DRAFT, never gated/executed" — FACTUALLY WRONG, added S74 without code archaeology). This PDR's P2 scope SHIPPED in S69 commit e7190b8 (seat rack + reducer peerCount + accessibility glyphs + you-emphasis + fixed buttons), the Council-escalated option B (presence broadcast) shipped as S70 P1 LOBBY_PRESENCE, stable seats as S73 P1, sender-auth as S79 P4. See the sibling archive `2026-06-06_PDR_S69_P2_lobby-seat-ux_P2-SHIPPED_P3-carried.md` (the accurate record) and HANDOFF_2026-06-06_S69.md. The S82 remainder (seatRack.test.ts pure-helper extraction, dead pane-alpha removal) closed in S82 P5. Preserved below verbatim for history; do NOT re-execute.
