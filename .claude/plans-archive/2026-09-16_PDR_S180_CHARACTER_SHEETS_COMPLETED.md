...
STATUS: COMPLETED — shipped, rejected in play, finished. Scope was EXPANDED by the owner in the approval turn (S180-A1) and again after playtest (S180-A4): buildings and the castle are in, FIX/SCRAP is absorbed, skills are out.
