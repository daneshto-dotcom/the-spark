**STATUS: IN-PROGRESS — PA (empty opening) and PB (per-kind weapon damage) SHIPPED as S148 P2 and deploy-verified. PC (castle HP + guns + elimination) NOT STARTED and is the next priority.**
