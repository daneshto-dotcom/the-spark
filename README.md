...
**In design (v0.6):** the economy pivot — a castle emits worker sparks that collect on your directives into a capped bank, and you build and sculpt from the bank instead of hauling. See [SPARK_v0.6_DESIGN.md](SPARK_v0.6_DESIGN.md).
...
- **[SPARK_v0.6_DESIGN.md](SPARK_v0.6_DESIGN.md)** — v0.6 design direction: the diagnosis, the reasoning, and the S126–S150 roadmap (economy pivot, trophy meta, endgame ceremony). Newer than the Blueprint where the two disagree.
