...
**Carry-forwards (logged):** pooped-pickup rejection UX cue (silent reject is the user-requested semantic; add feedback only if playtest wants it) · 10Hz client-mirror pose stepping advisory (flyover + all tick-driven renderers; judge in 1v1 playtest) · everything from S83 (playtest round 5 incl. Voltkin feel + S82 knobs, host-migration, EYES follow-ups, lobby D1, VFX lightning library user-deferred).
